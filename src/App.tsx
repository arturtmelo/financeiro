  ...
  return (
    <div id="top" className="min-h-screen pb-8">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-24 right-6 p-3 bg-white/90 hover:bg-white text-purple-600 rounded-full shadow-lg transition-all transform hover:scale-110 z-[1000] animate-fadeIn"
